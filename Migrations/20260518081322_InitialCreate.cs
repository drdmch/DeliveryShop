        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Order_DeliveryFee", "\"DeliveryFee\" >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Cart_Owner", "\"UserId\" IS NOT NULL OR \"SessionId\" IS NOT NULL");
                    table.CheckConstraint("CK_Cart_Quantity", "\"Quantity\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItem_PriceAtPurchase", "\"PriceAtPurchase\" >= 0");
